...
const weatherIcons = {
    ...
    63: '/veiculos-app/img/bx-cloud-rain.svg', // Chuva moderada
    65: '/veiculos-app/img/bx-cloud-rain-wind.svg', // Chuva forte
    71: '/veiculos-app/img/bx-snowflake.svg', // Neve leve
    73: '/veiculos-app/img/bx-snowflake.svg', // Neve moderada
    75: '/veiculos-app/img/bx-snowflake.svg', // Neve forte
    77: '/veiculos-app/img/bx-snowflake.svg', // Grãos de neve
    80: '/veiculos-app/img/bx-cloud-lightning.svg', // Chuva leve com trovoada
    81: '/veiculos-app/img/bx-cloud-lightning.svg', // Chuva moderada com trovoada
    82: '/veiculos-app/img/bx-thunder.svg', // Chuva forte com trovoada
    85: '/veiculos-app/img/bx-thunder.svg', // Neve leve com trovoada
    86: '/veiculos-app/img/bx-thunder.svg', // Neve forte com trovoada
...
export class HeaderProfile extends HTMLElement {
    ...
    async updateWeatherUI() {
        try {
            ...
            if (tempElement) {
                const iconPath = weatherIcons[weatherCode] || '/veiculos-app/img/bx-sun-bright.svg';
            ...
            if (windSpeedElement) {
                try {
                    const response = await fetch('/veiculos-app/img/bx-wind.svg');
                    const svgContent = await response.text();
